...
public class CustomBufferedReader01 extends BufferedReader {
    private static final int MAX_LINE_LENGTH = 100;

    public CustomBufferedReader01(Reader in) {
        super(in);
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            CustomBufferedReader01 customReader = new CustomBufferedReader01(fileReader);
